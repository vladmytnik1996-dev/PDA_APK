...
![Карта загружена](images/03_map_loaded_controls.png)
...
![Увеличенная карта](images/16_zoomed_map.png)
...
![Форма новой метки](images/04_new_marker_form.png)
...
![Карточка метки](images/05_marker_details_sheet.png)
...
![Карта с несколькими типами меток](images/06_map_with_markers.png)
...
![Список заданий](images/07_tasks_list.png)
...
![Редактор заметки](images/08_note_editor.png)

После сохранения запись появляется в списке.

![Сохранённая заметка](images/09_notes_list.png)
...
![Настройки GPS](images/10_data_gps.png)
...
![Кнопка передачи GPS-привязки](images/10_data_gps.png)
...
![QR-код GPS-привязки](images/13_qr_share_calibration.png)
...
![QR-код метки](images/12_qr_share_marker.png)
...
![Сканер QR](images/15_qr_camera_scanner.png)
...
![Проверка импорта](images/14_qr_import_preview.png)
...
![QR, резервная копия и сброс](images/11_data_qr_backup_reset.png)
