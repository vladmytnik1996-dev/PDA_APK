...
s=s.replace('package="by.smorhon.stalkerpda.v3"', 'package="by.smorhon.stalkerpda.v8.debug"', 1)
s=s.replace('android:versionName="1.0.6"', 'android:versionName="1.0.6-debug"', 1)
...
s=yml.read_text('utf-8').replace('versionName: 1.0.6', 'versionName: 1.0.6-debug', 1)
